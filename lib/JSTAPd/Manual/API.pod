...
=head2 pop_tap_request(function(reqest_list){});

# XXX - Need clarification
...
# XXX what happens if selector returns multiple elements?
...
# XXX Probably it would be better if there's an example
